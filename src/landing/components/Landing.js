    ...
    return (
      <PageContainer>
        ...
        <div className={cn.body}>
          <div className={`${cn.message} ${cn.firstMessage}`}>
            Don't want to register? Use test account: login - test, password - testtest.
          </div>
          <div className={`${cn.message} mt-md`}>
          ...
          <div className={`${cn.explanation} pb-lg mb-lg`}>
            It's the demo server, don't use in production environment
          </div>
          <YouTube
            videoId="XLUM4URSWjw"
            opts={{
