...
export class BooleanProp extends Component {
  static propTypes = {
    onClose: func.isRequired,
    onStepChange: func.isRequired,
    onFirstBack: func,
    onDone: func.isRequired,
    initialModel: instanceOf(BooleanSubmodelType),
  }
  ...
  onBlur(field) {
    dialogTypeOnBlur.call(this, { Type: BooleanSubmodelType, field })
  }

  onDone() {
    const { onDone } = this.props
    dialogTypeOnDone.call(this, {
      Type: BooleanSubmodelType,
