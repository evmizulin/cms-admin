...
export class AssetModel extends Component {
  static propTypes = {
    onClose: func.isRequired,
    onStepChange: func.isRequired,
    onFirstBack: func,
    onDone: func.isRequired,
    initialModel: instanceOf(AssetModelType),
  }
  ...
  onBlur(field) {
    dialogTypeOnBlur.call(this, { Type: AssetModelType, field })
  }

  onDone() {
    const { onDone } = this.props
    dialogTypeOnDone.call(this, { Type: AssetModelType, fields: ['apiId', 'title', 'description'], onDone })
  }
